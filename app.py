...
def configureDataBase():
    client = MongoClient("mongodb+srv://amitprna:88098@cluster0.mulj2.mongodb.net/covid19DB?retryWrites=true&w=majority")
...
if __name__ == "__main__":
    app.run(port=5000, debug=False) # running the app on the local machine on port 8000
